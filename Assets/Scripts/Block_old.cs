...
public class Block_old : MonoBehaviour
{
    ...
    Vector3[] vertices = new Vector3[8] { new Vector3(-0.5f, -0.5f,  0.5f),
                                          ...
                                          new Vector3( 0.5f,  0.5f, -0.5f),
                                          new Vector3(-0.5f,  0.5f, -0.5f)};
    //TODO: Wartości powinny być generowane dynamicznie zależnie od typu bloku.
    ...
    //Funkcja tworząca pojedyńcze ściany kostki.
    void CreateBlockSide(BlockSide side)
    {
        Mesh mesh = new Mesh();
        //Przypisz odpowiedznie wartosci do mesha.
    ...
    Mesh GenerateBlockSide(Mesh mesh, BlockSide side)
    {
        switch (side)
        {
            case BlockSide.FRONT:
                ...
                mesh.normals = Vector3[] { Vector3.forward, Vector3.forward, Vector3.forward, Vector3.forward };
            ...
            case BlockSide.BACK:
                ...
                mesh.normals = Vector3[] { Vector3.back, Vector3.back, Vector3.back, Vector3.back};
            ...
            case BlockSide.LEFT:
                ...
                mesh.normals = Vector3[] { Vector3.left, Vector3.left, Vector3.left, Vector3.left};
            ...
            case BlockSide.RIGHT:
                ...
                mesh.normals = Vector3[] { Vector3.right, Vector3.right, Vector3.right, Vector3.right};
            ...
            case BlockSide.TOP:
                ...
                mesh.normals = Vector3[] { Vector3.up, Vector3.up, Vector3.up, Vector3.up};
            ...
            case BlockSide.BOTTOM:
                ...
                mesh.normals = Vector3[] { Vector3.down, Vector3.down, Vector3.down, Vector3.down};
